...
/* Generally waits around 1-4 us, writes to an unused port
 * Taken from os dev */
static inline void io_wait(void) {
    outb(0x00, 0x80);
}

/* Enables NMI by writing 0 to bit 8 of port 0x70.
 * Ports 0x70 and 0x71 correspond to RTC, which also happen to control NMI.
 * Taken from os dev */
...
/* Disables NMI by writing 1 to bit 8 of port 0x70.
 * Ports 0x70 and 0x71 correspond to RTC, which also happen to control NMI.
 * Taken from os dev */
